    ...
    <section class="temp-section">
                    ...
                    <span class="input">
                        <span class="dv">
                            <select v-model="formData.authType" class="custom-select sm">
                                <option v-for="(item, index) in state.permissionLevel" :key="index" :value="item.value">
                                    {{ item.label }}
                                </option>
                            </select>
                        </span>
        ...
        <div class="ui-section flex align-start">
            <div class="ui-section wp-30">
                <subTitleBar :subTitle="'어드민 회원 목록'">
                    <template #btn>
...
export default {
    ...
    setup() {
        ...
        const initColum = ref([
            ...
            { headerName: '어드민', field: 'admnPtnrTyCdNm', flex: 1 },
        ...
        const clearList = (num) => {
            ...
            state.mskgnTried = false;
            state.mskgnRlsYn1 = true;// 마스킹 해제 여부
            state.mskgnTried1 = false;
