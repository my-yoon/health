        ...
        <div class="form-item">
            <div class="item">
                <span class="input">
                    ...
                    <span class="dv">
                        <input v-model="state.searchText" class="form-control sm" type="text" :readonly="state.searchType==''">
                    </span>
                </span>
            </div>
...
import {_getAdminList} from '@/api/sttl';
...
export default {
    ...
    setup(props) {
        ...
        const initColum = ref([
            ...
            {headerName: '회원번호', field: 'admnSn', flex: 1},
            {headerName: '회원명', field: 'admnNm', flex: 1},
            {headerName: 'ID', field: 'admnId', flex: 1},
            {
                headerName: '선택',
                field: 'select',
                maxWidth: 90,
        ...
        const state = reactive({
            ...
            searchTypeList: [
                {label: '선택', value: ''},
                {label: '회원명', value: 'admnNm'},
                // {label: '회원번호', value: 'mbrSn'},
                {label: '회원ID', value: 'admnId'},
            ]
        });
