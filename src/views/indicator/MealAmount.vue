...
import { _getMealAmount } from '@/api/indicator.js';
...
export default {
    ...
    setup() {
        ...
        // 차트조회
        const getMealAmountChart = async () => {
            try {
                // 차트 조회
                formData.schTy = 'C';
                await _getMealAmount(formData).then(result => {
        ...
        const excelParams = {
            params: formData,
            url: '/common/api/v1/statics/meal-amount/excel'
        };
