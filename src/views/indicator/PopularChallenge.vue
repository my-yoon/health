...
import { _getChallenge } from '@/api/indicator.js';
    ...
    setup() {
        ...
        const initColum = ref([
            ...
            },
            {
                headerName: '인기 챌린지',
                children: [
                    { headerName: '챌린지', field: 'chlg_nm' },
                    { headerName: '참여수', field: 'mbr_cnt', valueFormatter: toLocaleStringKo },
        ...
        const state = reactive({
            ...
            excelDown: {
                isReason: false,
                apiUrl: '/common/api/v1/statics/challenge/excel'
            },
        ...
        // 차트조회
        const getChallengeChart = async () => {
            try {
                // 차트 조회
                formData.schTy = 'C';
                await _getChallenge(formData).then(result => {
        ...
        const excelParams = {
            params: formData,
            url: '/common/api/v1/statics/challenge/excel'
        };
