...
import { _getDrinking } from '@/api/indicator.js';
import ChartBar from '@/views/indicator/components/ChartBar.vue';
import SelectBox from '@/components/ui/SelectBox.vue';
import { toGridUnit, toLocaleStringKo } from '@/views/indicator/util/chart.js';
...
export default {
    ...
    setup() {
        ...
        // 차트조회
        const getDrinkingChart = async () => {
            try {
                // 차트 조회
                formData.schTy = 'C';
                await _getDrinking(formData).then(result => {
        ...
        const excelParams = {
            params: formData,
            url: '/common/api/v1/statics/drinking/excel'
        };
