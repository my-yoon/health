<template>
    <section>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span v-if="!checkValidState('admnPwd')" class="input-guide">영문, 숫자, 특수기호의 조합으로 8~16자리를
                                        입력해 주세요.</span>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="reg-group">
                                        <div class="reg-item">
                                            <input type="text"
                                                ...
                                                :disabled="state.brnCheck === 'Y'" v-model="formData.ntprNm">
                                        </div>
                                        <div class="reg-item">
                                            <span class="checkbox">
                                                <input id="columChk1" name="columChkGroup" type="checkbox"
                                                    :disabled="state.brnCheck === 'Y'" v-model="state.kbAffiYn">
                                    ...
                                    <span v-else class="input-guide">사업자등록증 법인명과 동일한 기업명을 입력해 주세요.</span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">메디컬구분<span class="ess"><span class="offscreen">필수입력</span></span></th>
                                <td colspan="3">
                                    <div class="reg-group">
                                        <div class="reg-item">
                                            <span class="radio" v-for="(item, index) in state.medicallist" :key="index">
                                                <input :id="'service0' + index" name="openRdo" type="radio"
                                                    :value="item.value" v-model="formData.mdclCd">
                                                <label :for="'service0' + index">{{ item.label }}</label>
                                            </span>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="reg-group">
                                        <div class="reg-item">
                                            <input type="text" :class="['form-control', { error: checkValidState('brn') }]"
                                                ...
                                                @input="setInputNumber" :disabled="state.brnCheck === 'Y'">
                                        </div>
                                    ...
                                    <span v-else class="input-guide">사업자등록번호 중복체크를 해주세요.</span>
                                </td>
                                    ...
                                    <div class="reg-group">
                                        <div class="reg-item">
                                            <input type="text"
                                                ...
                                                :disabled="state.brnCheck === 'Y'" v-model="formData.bcoNm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="reg-group">
                                        <div class="reg-item">
                                            <input type="text"
                                                ...
                                                :disabled="state.brnCheck === 'Y'" v-model="formData.indtpNm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="reg-group">
                                        ...
                                        <div class="reg-item">
                                            <input type="text" class="form-control" maxlength="4" :value="state.faxMno"
                                                :disabled="state.brnCheck === 'Y'" data-target="faxMno"
                                                @input="setInputNumber">
                                        </div>
                                        <span class="ui-coupler">-</span>
                                        <div class="reg-item">
                                            <input type="text" class="form-control" maxlength="4" :value="state.faxBno"
                                                :disabled="state.brnCheck === 'Y'" data-target="faxBno"
                                                @input="setInputNumber">
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="reg-group">
                                        <div class="reg-item">
                                            <commselect :selectType="'searchCode.bkcd'" @changedValue="selectedOptions"
                                                :disabled="state.brnCheck === 'Y'" :initData="formData.bkcd"
                                                ref="bankName" />
                                        </div>
                                        <div class="reg-item">
                                        ...
                                        <div class="reg-item">
                                            <input type="text"
                                                ...
                                                :disabled="state.brnCheck === 'Y'" placeholder="예금주명"
                                    ...
                                    <div class="reg-group">
                                        ...
                                        <div class="reg-item">
                                            <button type="button" class="btn btn-slm"
                                                ...
                                                @click="modalOpen('isShowCcd', formData.ntprUcd)">중복체크</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="reg-group inline">
                                        <div class="reg-item">
                                            <input type="text"
                                                ...
                                                :disabled="state.brnCheck === 'Y'" v-model="formData.dlngPlcCd">
                                        </div>
                                    </div>
                ...
                <div class="tbl-wrap">
                    <table class="table reg">
                        ...
                        <tbody>
                            ...
                            <tr v-if="formData.mdclCd !== '113001'">

                                <th scope="row">의사면허증 사본<span class="ess"><span class="offscreen">필수입력</span></span></th>
                                <td colspan="3">
                                    <!-- 법인계좌 사본 첨부파일순번:
                                    {{ formData.ntprAcnCpAtflSn }} -->
                                    <div class="reg-group">
                                        <div class="reg-item">
                                            <div class="btn-file">
                                                <input type="file" id="upload-file2" hidden="" ref="fileUploadMed"
                                                    @change="fileListUp('medicalfilelist')">
                                                <label class="btn-up" for="upload-file2">파일첨부</label>
                                            </div>
                                            <span class="input-guide inline">용량 : 2MB 이하 | 형식 : jpg, gif, pdf</span>
                                    ...
                                    <div class="upload-file-box">
                                        ...
                                        <div class="upload-file-list">
                                            <div class="upload-file-list-item flex space-between"
                                                v-for="(item, index) in state.medicalfilelist" :key="index">
                                                <button type="button" class="btn del btn-secondary"
                                                    @click="fileListDel('medicalfilelist')">
                                                    <span class="offscreen">파일삭제</span>
                                                </button>
                                                <span class="name">{{ item.name }}</span>
                                                <span class="volume">{{ (item.size / (1024 * 1024)).toFixed(1) }} MB</span>
                                    ...
                                    <span v-if="checkValidState('dctCoqCpAtflSn')" class="input-guide"
                                        :class="{ 'error': checkValidState('dctCoqCpAtflSn') }">
                                        {{ state.validState.message }}
                                    </span>
                                </td>
                            </tr>
        ...
        <div class="btn-bottom-set flex justify-center">
            <button type="button" class="btn btn-sl nega" @click="goToPage('/medical/regist/list')">취소</button>
...
import { _regMedicalRequest, _duplicateEidCheck, _duplicateCcdCheck, _duplicateEmailCheck, _duplicateCheck } from '@/api/medical.js';
...
export default {
    ...
    setup() {
        ...
        const formData = reactive({
            ...
            dctCoqCpAtflSn: computed(() => state.dctCoqCpAtflSn), //의사면허증 첨부파일순번
            admnLvlId: 'E00', // 관리자레벨 Manager:C00,Associate:C01
        ...
        watch(() => [state.brnType1, state.brnType2, state.brnType3], () => { // 사업자등록번호
            state.brnCheck = '';
        });
        ...
        const resetFormData = () => {
            ...
            state.dctCoqCpAtflSn = '';
            formData.admnLvlId = 'E00'; // 관리자레벨 Manager:C00,Associate:C01
        ...
        const modalOpen = async (modalName, params) => {
            ...
            if (modalName === 'isShowID') {
                ...
                if (state.brnCheck === 'Y' && state.membertype !== null) {
                    console.log('state.brnCheck', state.membertype.includes('111004'));
                    let joinType = '';
                    ...
                    if (state.membertype.includes('111004')) { // 메디컬로 가입 되어 있을 때 ( 여기는 메디컬 가입 페이지 )
                        msg = '메디컬 파트너로 가입되어 있는 사업자등록번호 입니다. 동일 사업자등록번호로 중복가입이 불가 합니다.';
                    } else {
                ...
                $Modal.simple({
                    ...
                    .then(success => {
                        if (state.brnCheck === 'Y') {
                            if (state.membertype !== null && state.membertype.includes('111004')) {
                                state.brnType1 = '';
                                state.brnType2 = '';
                                state.brnType3 = '';
                                state.brnCheck = '';
        ...
        const duplicateEidCheck = async () => {
            try {
                ...
                if (response.data.code === 'OK') {
                    ...
                    response.data.data.ntprSn === null ? state.ntprSn = '' : state.ntprSn = response.data.data.ntprSn;
                } else {
            ...
            if (validFormData()) {
                ...
                $Modal.confirm({
                    ...
                    .then(async (success) => {
                        console.log(success);
                        let filelist = [];
                        formData.mdclCd === '113001' ? filelist = ['bizBanklist', 'bizfilelist'] : filelist = ['bizBanklist', 'bizfilelist', 'medicalfilelist'];
                        for (const item of filelist) {
                            await uploadFile(item);
                        }
                        await regMedicalRequest();
        ...
        const regMedicalRequest = async () => {
            try {
                let params = {
                    ...
                    dctCoqCpAtflSn: String(formData.dctCoqCpAtflSn),
                    admnLvlId: formData.admnLvlId,
                    dlngPlcCd: formData.dlngPlcCd,
                    ntprSn: formData.ntprSn
                };

                const response = await _regMedicalRequest(params);
                if (response.data.code === 'OK') {
        ...
        const fileListUp = async (type) => {
            resetState();
            let inputName = null;
            type === 'bizfilelist' ? inputName = fileUploadBiz : type === 'medicalfilelist' ? inputName = fileUploadMed : inputName = fileUploadBankBiz;
            console.log(type, inputName.value);
        ...
        const uploadFile = async (type) => {
            ...
            try {
                ...
                } else if (type === 'medicalfilelist') {
                    state.dctCoqCpAtflSn = response.data.fileId;
                } else {
        ...
        const validFormData = () => {
            let target = [];
            formData.mdclCd === '113001' ?
                target = ['admnId', 'admnPwd', 'checkAdmnPwd', 'ntprNm', 'brn', 'rprsvNm', 'bcoNm', 'indtpNm', 'rprsTlnoMno', 'adr', 'bkcd', 'acno', 'accountNm', 'ntprUcd', 'dlngPlcCd', 'admnDepNm', 'admnNm', 'admnHhpnoFno', 'admnHhpnoMno', 'admnHhpnoBno', 'admnEmad', 'bzlcCpAtflSn', 'ntprAcnCpAtflSn'] :

                target = ['admnId', 'admnPwd', 'checkAdmnPwd', 'ntprNm', 'brn', 'rprsvNm', 'bcoNm', 'indtpNm', 'rprsTlnoMno', 'adr', 'bkcd', 'acno', 'accountNm', 'ntprUcd', 'dlngPlcCd', 'admnDepNm', 'admnNm', 'admnHhpnoFno', 'admnHhpnoMno', 'admnHhpnoBno', 'admnEmad', 'bzlcCpAtflSn', 'ntprAcnCpAtflSn', 'dctCoqCpAtflSn'];

            for (const item of target) {
                console.log('check check >>', item, _.isEmpty(formData.brn));
                ...
                // 예외 케이스 (의사면허증 사본 등록)
                if (item === 'dctCoqCpAtflSn' && _.isEmpty(state.medicalfilelist)) {
                    state.validState.message = '의사면허증 사본을 등록해주세요.';
                    state.validState.errState = true;
                    break;
                }

                if (_.isEmpty(formData[item]) &&
                    !(item === 'bzlcCpAtflSn' || item === 'ntprAcnCpAtflSn' || item === 'dctCoqCpAtflSn' || item === 'checkAdmnPwd') // 예외 ( formData 없는 아이들 )
                ) {
                    state.validState.errState = true;
                    break;
                }
