...
import { _getMedicalInfo } from '@/api/medical.js';
export default {
    ...
    setup() {
        ...
        const exelParams = {
            params: formData,
            url: '/common/api/v1/medical/medical-information/excel'
        };
        ...
        const onCellClicked = (e) => {
            console.log(e.data);
            goToPage(`/medicalinfodetail?Sn=${e.data.sn}`);
        };
        // 삭제할 컬럼 선택
        ...
        const getMedicalInfo = async () => {
            try {
                ...
                console.log(params);
                const response = await _getMedicalInfo(params);
