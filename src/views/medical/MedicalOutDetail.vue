<template>
    <section>
                        ...
                        <table class="table reg">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ state.joinRequestDetail.mdclCd }}</td>
                                ...
                                <tr>
                                    ...
                                    <th scope="row">거래처코드(더존ERP) <span class="ess"><span
        ...
        <div class="btn-bottom-set flex justify-center">
            <button type="button" class="btn btn-sl nega" @click="goToPage('/medical/ban/list')">
                목록
            </button>
        </div>
...
import { _getMedicalOutDetail } from '@/api/medical.js';
...
export default {
    ...
    setup() {
        ...
        const { goToPage, formatterBrn, openModal } = useCommFunc();
        ...
        onMounted(() => {
            ...
            getMedicalOutDetail(state.detailNum);
        ...
        // 상세
        const getMedicalOutDetail = async () => {
            try {
                const response = await _getMedicalOutDetail(state.detailNum);
