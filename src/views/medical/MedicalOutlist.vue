...
import { _getMedicalOutList } from '@/api/medical.js';
export default {
    ...
    setup() {
        ...
        const exelParams = {
            params: formData,
            url: '/common/api/v1/medical/medical-secession/excel'
        };
        ...
        const onCellClicked = (e) => {
            console.log(e.data);
            goToPage(`/medicaloutdetail?Sn=${e.data.sn}`);
        };
        // 삭제할 컬럼 선택
        ...
        const getMedicalOutList = async () => {
            try {
                ...
                console.log(params);
                const response = await _getMedicalOutList(params);
