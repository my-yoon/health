        ...
        <div class="tbl-wrap">
            ...
            <div v-else>
                <AgGridVue :columnDefs="state.tableColum_c" :rowData="state.memberInfoList"
                    :defaultColDef="state.defaultColDef" @grid-ready="onGridReady" @cell-clicked="onCellClicked"
                    class="ag-theme-alpine" :domLayout="state.domLayout" style="width:100%">
                </AgGridVue>
...
<script>
import { getCurrentInstance, computed, reactive, inject, onMounted, ref, watchEffect, watch, onUnmounted } from 'vue';
...
export default {
    ...
    setup() {
        ...
        const onCellClicked = (e) => {
            console.log(e.data);
            goToPage(`/member/detail?mbrSn=${e.data.mbrSn}`);
        };
