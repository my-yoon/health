...
import { _getDevOutList } from '@/api/developer.js';
export default {
    ...
    setup() {
        ...
        const { goToPage, tableResize, openModal, isPartnerShow, isDownShow, formatterBrn } = useCommFunc();
        ...
        const initColum = ref([
            ...
            { headerName: '탈퇴처리일자', field: 'admnScsnDt', maxWidth: 90 }
        ...
        const exelParams = {
            params: formData,
            url: '/common/api/v1/developer/developer-secession/excel'
        };
        ...
        const onCellClicked = (e) => {
            console.log(e.data);
            goToPage(`/developeroutdetail?Sn=${e.data.sn}`);
        };
        // 삭제할 컬럼 선택
        ...
        const getDevOutList = async () => {
            try {
                ...
                console.log(params);
                const response = await _getDevOutList(params);
