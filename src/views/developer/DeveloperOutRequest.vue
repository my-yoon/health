...
import { _getDevOutRequest } from '@/api/developer.js';
export default {
    ...
    setup() {
        ...
        const exelParams = {
            params: formData,
            url: '/common/api/v1/developer/developer-secession-request/excel'
        };
        ...
        const onCellClicked = (e) => {
            console.log(e.data);
            goToPage(`/developeroutrequestdetail?Sn=${e.data.sn}`);
        };
        // 삭제할 컬럼 선택
        ...
        const getDevOutRequest = async () => {
            try {
                ...
                console.log(params);
                const response = await _getDevOutRequest(params);
