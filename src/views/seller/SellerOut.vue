...
import { _getSellerOutlist } from '@/api/seller.js';
export default {
    ...
    setup() {
        ...
        const formData = reactive({
            ...
            bzmTyDtlCd: '',  // 사업자유형
            svcSe: '', // 서비스구분
            pnltAplYn: computed(() => state.pnltAplYn ? 'Y' : ''), // 패널티 적용
        ...
        const onCellClicked = (e) => {
            console.log(e.data);
            goToPage(`/selleroutdetail?ntprSn=${e.data.sn}`);
        };
        // 삭제할 컬럼 선택
        ...
        const getSellerOutlist = async () => {
            try {
                ...
                console.log(params);
                const response = await _getSellerOutlist(params);
