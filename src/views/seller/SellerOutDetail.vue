<template>
    <section>
                    ...
                    <table class="table reg">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ state.outRequestDetail.bzmTyNm }}/ {{ state.outRequestDetail.bzmTyDtlNm }}</td>
                            ...
                            <tr>
                                <th scope="row">서비스 타입</th>
                                <td>
                                    {{ state.outRequestDetail.admnPtnrSelrSvcTyNm }}
                                </td>
                            ...
                            <tr>
                                ...
                                <td>{{ state.outRequestDetail.pnltAplYn }}</td>
                                <th scope="row">마진율</th>
                                <td>{{ state.outRequestDetail.mgnRt }}</td>
                            </tr>
                            <tr>
        ...
        <div class="btn-bottom-set flex justify-center">
            <button type="button" class="btn btn-sl nega" @click="goToPage('/seller/ban/list')">목록</button>
        </div>
    </section>
</template>
<script>
...
import { _getSellerOutDetail } from '@/api/seller.js';
...
export default {
    ...
    setup() {
        ...
        // 상세조회
        const getSellerOutDetail = async () => {
            try {
                let params = {
                    mskgnRlsYn: 'N'
                };
                const response = await _getSellerOutDetail(state.detailNum, params);
